...
## Introducción
Este documento proporciona información detallada sobre el sistema, incluyendo su estructura, 
herramientas utilizadas y metodologías clave. Sirve como referencia para el uso del sistema.
...
- **Antivirus**: No interfiere con el sistema
- **Firewall**: No interfiere con el sistema
- **JavaFX**: 11.0.2 o superior
- **JRE**: 1.8 o superior
- **JDK**: 1.8 o superior
- **IDE**: NetBeans 12.0 o superior
- **Compilador**: Java 1.8 o superior
- **Dependencias**: JavaFX SDK 11.0.2 o superior
- **Librerías**: JavaFX 11.0.2 o superior

### Vista Principal
La vista principal del sistema muestra las opciones disponibles para el usuario.
Esta vista se compone de los siguientes elementos:
- **Menú de Opciones**: Barra de menú con las opciones disponibles.
Posee 3 opciones principales:

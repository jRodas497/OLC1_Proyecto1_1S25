...
"true"                          {return new Symbol(Terminal.PR_true,                yyline, yychar, yytext());}
"false"                         {return new Symbol(Terminal.PR_false,               yyline, yychar, yytext());}
"random"                        {return new Symbol(Terminal.PR_random,              yyline, yychar, yytext());}
"opponent_history"              {return new Symbol(Terminal.PR_opponent_history,    yyline, yychar, yytext());}
"self_history"                  {return new Symbol(Terminal.PR_self_history,        yyline, yychar, yytext());}
